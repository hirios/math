/* Grade 4 Activities Page JavaScript - Meadow Math */

/**
 * Grade 4 page controller
...
const Grade4Page = {
  ...
  async loadData() {
    try {
      ...
      const response = await fetch(`${basePath}/data/grade4.json`);
      ...
      console.error('Error loading Grade 4 data:', error);
      this.renderError();
    }
  },
