/* Grade 5 Activities Page JavaScript - Meadow Math */

/**
 * Grade 5 page controller
...
const Grade5Page = {
  ...
  async loadData() {
    try {
      ...
      const response = await fetch(`${basePath}/data/grade5.json`);
      ...
      console.error('Error loading Grade 5 data:', error);
      this.renderError();
    }
  },
